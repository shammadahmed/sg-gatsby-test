...
const BlockRichText=({data})=>{return/*#__PURE__*/index_js_default().createElement("div",{className:"prose mx-auto py-8"},/*#__PURE__*/index_js_default().createElement("div",{dangerouslySetInnerHTML:{__html:data.richTextBody.data.childMarkdownRemark.html}}));};/* harmony default export */ const block_rich_text = (BlockRichText);
...
;// CONCATENATED MODULE: ./src/components/block-media.js
const BlockMedia=({data})=>{const isVideo=data.file.mime.startsWith("video");return/*#__PURE__*/index_js_default().createElement("div",{className:"py-8"},isVideo?/*#__PURE__*/index_js_default().createElement("p",null,"TODO video"):/*#__PURE__*/index_js_default().createElement(gatsby_image_module/* GatsbyImage */.HN,{image:(0,gatsby_image_module/* getImage */.gJ)(data.file.localFile),alt:data.file.alternativeText}));};/* harmony default export */ const block_media = (BlockMedia);
;// CONCATENATED MODULE: ./src/components/block-quote.js
const BlockQuote=({data})=>{return/*#__PURE__*/index_js_default().createElement("div",{className:"py-6"},/*#__PURE__*/index_js_default().createElement("blockquote",{className:"container max-w-xl border-l-4 border-neutral-700 py-2 pl-6 text-neutral-700"},/*#__PURE__*/index_js_default().createElement("p",{className:"text-5xl font-medium italic"},data.quoteBody),/*#__PURE__*/index_js_default().createElement("cite",{className:"mt-4 block font-bold uppercase not-italic"},data.title)));};/* harmony default export */ const block_quote = (BlockQuote);
// EXTERNAL MODULE: ./node_modules/react-slick/lib/index.js
var lib = __webpack_require__(6066);
;// CONCATENATED MODULE: ./src/components/block-slider.js
const BlockSlider=({data})=>{return/*#__PURE__*/index_js_default().createElement("div",{className:"container max-w-3xl py-8"},/*#__PURE__*/index_js_default().createElement(lib/* default */.Z,{dots:true,infinite:true,speed:300,slidesToShow:1,slidesToScroll:1,arrows:true,swipe:true},data.files.map(file=>/*#__PURE__*/index_js_default().createElement(gatsby_image_module/* GatsbyImage */.HN,{key:file.id,image:(0,gatsby_image_module/* getImage */.gJ)(file.localFile),alt:file.alternativeText}))));};/* harmony default export */ const block_slider = (BlockSlider);
;// CONCATENATED MODULE: ./src/components/blocks-renderer.js
const componentsMap={STRAPI__COMPONENT_SHARED_RICH_TEXT:block_rich_text,STRAPI__COMPONENT_SHARED_MEDIA:block_media,STRAPI__COMPONENT_SHARED_QUOTE:block_quote,STRAPI__COMPONENT_SHARED_SLIDER:block_slider};const Block=({block})=>{const Component=componentsMap[block.__typename];if(!Component){return null;}return/*#__PURE__*/index_js_default().createElement(Component,{data:block});};const BlocksRenderer=({blocks})=>{return/*#__PURE__*/index_js_default().createElement("div",null,blocks.map((block,index)=>/*#__PURE__*/index_js_default().createElement(Block,{key:`${index}${block.__typename}`,block:block})));};const query="1511095222";/* harmony default export */ const blocks_renderer = (BlocksRenderer);
...
/* harmony import */ var _components_blocks_renderer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(889);
/* harmony import */ var _components_seo__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8183);
const ArticlePage=({data})=>{var _article$cover,_article$cover2;const article=data.strapiArticle;const seo={metaTitle:article.title,metaDescription:article.description,shareImage:article.cover};return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_layout__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z,{as:"article"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_seo__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z,{seo:seo}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("header",{className:"container max-w-4xl py-8"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1",{className:"text-6xl font-bold text-neutral-700"},article.title),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",{className:"mt-4 text-2xl text-neutral-500"},article.description),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_4__/* .GatsbyImage */ .HN,{image:(0,gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_4__/* .getImage */ .gJ)(article===null||article===void 0?void 0:(_article$cover=article.cover)===null||_article$cover===void 0?void 0:_article$cover.localFile),alt:article===null||article===void 0?void 0:(_article$cover2=article.cover)===null||_article$cover2===void 0?void 0:_article$cover2.alternativeText,className:"mt-6"})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("main",{className:"mt-8"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_blocks_renderer__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z,{blocks:article.blocks||[]})));};const pageQuery="2048574034";/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ArticlePage);
...
var _react = _interopRequireDefault(__webpack_require__(4995));
